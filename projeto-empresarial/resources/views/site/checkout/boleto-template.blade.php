...
<div class="document">
    <table cellspacing="0" cellpadding="0">
        <tr class="topLine">
            ...
            <td class="sideBorders center"><span style="font-size:24px;font-weight:bold;">001-7</span></td>
            <td class="boletoNumber center"><span>00191.12345 67890.101112 13141.516171 8 12345678901112</span></td>
        </tr>
    </table>
    <table cellspacing="0" cellpadding="0" border="1">
        <tr>
            ...
            <td width="30%">
                ...
                <br/>
                <br/>
                <p class="content right text" style="font-weight:bold;">{{\Carbon\Carbon::now()->addDays(2)->format('d/m/Y') }}</p>
            </td>
        </tr>
        <tr>
            <td width="70%" colspan="6">
                ...
                <table border="0" style="border:none">
                    <tr>
                        <td width="60%"><span class="text">Água Marinha</span></td>
                        <td><span class="text">CNPJ 01.000.000/0001-00</span></td>
                    </tr>
                </table>
                <span class="text">Rua Pedras Preciosas, 1 - Paraíso - Rio de Janeiro - RJ - 21000-000</span>
            </td>
            <td width="30%">
        ...
        <tr>
            <td width="15%">
                ...
                <br/>
                <p class="content center">{{formatDateTime(\Carbon\Carbon::now()) }}</p>
            </td>
