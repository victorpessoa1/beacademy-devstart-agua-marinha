...
@section('content')
        ...
        <div class="flex shadow-md my-10">
          <div class="w-3/4 bg-white px-10 py-10">
            ...
            <a href="/" class="flex font-semibold text-green-600 text-sm mt-10">
              ...
              Adicionar mais cryptos ao carrinho
            </a>
          </div>
          ...
          <div id="summary" class="w-1/4 px-8 py-10">
            ...
            <div>
              <label class="font-medium inline-block mb-3 text-sm uppercase">Taxa Água Marinha</label>
  ...
  @else
    <div class="container mx-auto px-60 py-8" style="margin-top:-60px;">
      <h1 class="text-2xl text-center py-8 bg-white font-extrabold">Nenhuma Crypto Selecionada.</h1>
      <div class="container mx-auto px-60 py-8 bg-white flex justify-center">
      ...
      <div class="container mx-auto px-60 py-8 bg-white" style="margin-top:-35px; ">
        <a href="/" class="flex justify-center bg-white hover:bg-blue-400 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">Voltar</a>
      </div>
    </div>
